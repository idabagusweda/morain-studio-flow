...
const WHATSAPP_MESSAGE = 'Halo Morain, saya ingin bertanya tentang layanan studio foto.';
    ...
    <section id="kontak" className="section-padding">
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">hello@morainstudio.com</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">@morainstudio</p>
              </div>
            </div>
            ...
            <Button variant="whatsapp" size="lg" onClick={openWhatsApp} className="w-full sm:w-auto">
          ...
          {/* Map Placeholder */}
          <div className="bg-secondary rounded-2xl h-[400px] lg:h-full min-h-[300px] flex items-center justify-center border border-border overflow-hidden">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d63202.40403442799!2d115.17545295!3d-8.6704582!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd2408f0396f5cf%3A0x4c0bfb2bb88ccfae!2sDenpasar%2C%20Denpasar%20City%2C%20Bali!5e0!3m2!1sen!2sid!4v1699999999999!5m2!1sen!2sid"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
